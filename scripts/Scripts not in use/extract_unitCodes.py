...
# Deduplicate and preserve order of unit codes
...
# Extracts unit codes from the PDF and organizes them by semester
def extract_units_by_semester(pdf_path, semester_blocks):
    ...
    # Extract all semesters from the semester blocks
    all_semesters = set()
